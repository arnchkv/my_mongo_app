...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { building: @classroom.building, floor: @classroom.floor, section: @classroom.section } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { building: @classroom.building, floor: @classroom.floor, section: @classroom.section } }
